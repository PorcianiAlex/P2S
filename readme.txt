...
TO CONFIG:
CONNECTIONS:
	RMIPORT, SOCKETPORT AND IP --> Connection.json in main directory.
CARD: 
...
FIFTH PLAYER:
We have introduced an extra player, called The Conspirator (color Black), with 0 resources, 0 points and 0 cards how can not win. He has to take the place of another player.
That's how it works:
1. At the beginning of every round he can make 4 turns on a row.
2. His goal is to guess where the other players are going to place their family Member, so he just have to place his 4 black family members on the board. (THEY WILL NOT BE VISIBLE).
...
Once a player who is in a saved game, that is over, logs in, he's asked if he wants to load the saved gamed.
If he answer NO, he goes in the lobby.

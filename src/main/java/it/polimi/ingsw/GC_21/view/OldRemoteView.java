...
public class OldRemoteView extends Observable<Action> implements P2SObserver, Runnable { 
  ...
  public OldRemoteView(Socket socket, ControllerManager controlloreManager) throws IOException { 
    this.socket = socket; 
...
public OldRemoteView(RmiClientInterface rmiClient, ControllerManager controlloreManager) { 
  ...
  @Override 
    ...
    if(choice.equals("C")) { 
        game = controlloreManager.createGame(); 
...
public ControllerManager getControlloreManager() {
	return controlloreManager;
}

public void setControlloreManager(ControllerManager controlloreManager) {
	this.controlloreManager = controlloreManager;
}

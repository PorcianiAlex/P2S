...
public class ForEachGetTest {
	...
	System.out.println(testPlayer.getMyPersonalBoard().getSpecificOwnedCards(DevCardType.Building).getOwnedCardsnumber());
	System.out.println(testPlayer.getMyPersonalBoard().getSpecificOwnedCards(DevCardType.Building).getMyOwnedCards()[0].toString());
